    ...
    def start_linkedin(self, username, password):
        ...
        try:
            ...
            login_button = self.browser.find_element(
                by=By.CSS_SELECTOR, value=".btn__primary--large")
        ...
        while time.time() - start_time < self.MAX_SEARCH_TIME:
            try:
                ...
                scrollresults = self.browser.find_element(
                    by=By.CLASS_NAME, value="jobs-search-results")
                ...
                links = self.browser.find_elements(
                    by=By.XPATH, value='//div[@data-job-id]')
                ...
                for link in links:
                    children = link.find_elements(
                        by=By.XPATH, value='.//a[@data-control-name]')
    ...
    def get_easy_apply_button(self):
        try:
            button = self.browser.find_elements(
                by=By.XPATH, value='//button[contains(@class, "jobs-apply")]/span[1]')
